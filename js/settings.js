const Settings = (() => {
  const translations = {
    zh: {
      ...
      deleteProjectConfirm: '确定删除此项目？此操作不可撤销！',
      cancel: '取消',
      confirm: '确认',
      stationType: '站点类型',
      normalStation: '普通站',
      ...
      exportPreview: '导出预览',
      startDownload: '开始下载',
      exportMlmdt: '导出 MLMDT 文件',
      mlmdtHint: '导出项目文件（.mlmdt），包含所有站点、线路和文本数据。\n该文件仅可使用本工具的"导入项目"功能导入，用于项目备份与迁移。',
      station: '站点',
      line: '线路',
      text: '文本',
      select: '选择',
    ...
    en: {
      ...
      exportMlmdt: 'Export MLMDT File',
      mlmdtHint: 'Export project file (.mlmdt) containing all stations, lines and text data.\nThis file can only be imported using the "Import Project" feature of this tool, used for project backup and migration.',
      station: 'Station',
      line: 'Line',
      text: 'Text',
      select: 'Select',
